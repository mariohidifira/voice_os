...
CREDENTIALS: dict[str, tuple[tuple[str, str], ...]] = {
    ...
    "AWS_ACCESS_KEY_ID": (("VOICEOS.AWS_ACCESS_KEY_ID", "ACCESS_KEY_ID"),),
    "AWS_SECRET_ACCESS_KEY": (("VOICEOS.AWS_SECRET_ACCESS_KEY", "SECRET_ACCESS_KEY"),),
    "AWS_REGION": (
        ("VOICEOS.AWS_REGION", "REGION"),
        ("VOICEOS.AWS_REGION", "API_KEY"),
    ),
    "TWILIO_ACCOUNT_SID": (("VOICEOS.TWILIO_ACCOUNT_SID", "ACCOUNT_SID"),),
    "TWILIO_AUTH_TOKEN": (("VOICEOS.TWILIO_AUTH_TOKEN", "AUTH_TOKEN"),),
    "TWILIO_MESSAGING_SERVICE_SID": (
        ("VOICEOS.TWILIO_MESSAGING_SERVICE_SID", "MESSAGING_SERVICE_SID"),
        ("VOICEOS.TWILIO_MESSAGING_SERVICE_SID", "API_KEY"),
    ),
    "STRIPE_SECRET_KEY": (("VOICEOS.STRIPE_SECRET_KEY", "SECRET_KEY"),),
    "STRIPE_WEBHOOK_SECRET": (
        ("VOICEOS.STRIPE_WEBHOOK_SECRET", "WEBHOOK_SECRET"),
        ("VOICEOS.STRIPE_WEBHOOK_SECRET", "API_KEY"),
    ),
}
