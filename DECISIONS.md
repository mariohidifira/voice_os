...
- 2026-08-22: `behavior.business_hours` is configured as `{timezone, weekdays}` JSON, where each weekday/group maps to one or more `[HH:MM, HH:MM]` local-time intervals; `null` disables enforcement.
